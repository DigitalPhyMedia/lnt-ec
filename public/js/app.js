document.addEventListener("DOMContentLoaded", function () {
    // const forms = document.querySelectorAll(".js-email-form");
    ...
    //     fetch("https://your-backend.com/submit-form", { // Replace with actual backend URL
    //         method: "POST",
    //         body: formData
    //     })
    //         .then(response => {
    ...
    forms.forEach(function (e) {
        e.addEventListener('submit', function (event) {
            ...
            const nameField = thisForm.querySelector('uname');
            ...
            // Validate Phone:
            const phoneField = thisForm.querySelector('umobile');
            ...
            if (thisForm.querySelector("uemail")) {
                const emailField = thisForm.querySelector("uemail");
    ...
    function sendEmail(formData, form) {
        ...
        var email = formData.get("uemail");
        var phone = formData.get("umobile");
        ...
        emailjs.send(emailData.service_id, emailData.template_id, emailData.template_params)
            .then(response => {
                ...
                if (response.status === 200) {
                    ...
                    throw new Error(response.text || 'Unexpected response from email server.');
                }
            })
            .catch(error => {
